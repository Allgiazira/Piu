            ...
            do
            {
                ...
                switch (optiune.ToUpper())
                {
                    ...
                    case "A":
                        ...
                        break;
                    case "F":
                        TargMasini[] studenti = adminMasini.GetMasini(out nrMasini);
                        AfisareMasini(studenti, nrMasini);
                        break;
...
//Lab3 afisarea datelor din fisier
        public static void AfisareMasini(TargMasini[] studenti, int nrStudenti)
        {
            Console.WriteLine("Studentii sunt:");
            for (int contor = 0; contor < nrStudenti; contor++)
            {
                AfisareMasina(studenti[contor]);
            }
        }
